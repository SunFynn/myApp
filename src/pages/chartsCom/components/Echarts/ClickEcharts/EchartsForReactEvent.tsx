...
const BarCharts = (props: any) => {
  ...
  const onEvents = useMemo(() => {
    return {
      click: (item: any) => {
        console.log(item, 'echarts-for-react图表绑定点击事件');
      },
    };
  }, []);
...
interface EchartsForReactEventProps {}

const EchartsForReactEvent: FunctionComponent<EchartsForReactEventProps> = () => {
...
export default EchartsForReactEvent;
