...
;!function(window, document){ // gulp build: laydate-header
  ...
  */
  ...
  Class.prototype.lang = function(){
    ...
    ,text = {
      ...
      'ja-JP': {
        ...
        timeout: '終了時間は開始時間より早くすることはできませんもう一度選択してください',
        invalidDate: '有効な日付または時間の範囲外です',
        formatError: ['日付の形式が無効です次の形式に従う必要があります：<br>', '<br>リセットしました'],
        preview: '現在選択中の結果'
      }
    };
    return text[options.lang] || text['zh-CN'];
  };
  ...
  Class.prototype.init = function(){
    ...
    //记录重要日期
    options.mark = lay.extend({}, (options.calendar && options.lang === 'zh-CN') ? {
      '0-1-1': '元旦'
      ,'0-2-14': '情人'
      ,'0-3-8': '妇女'
      ,'0-3-12': '植树'
  ...
  Class.prototype.render = function(){
    ...
    lay.each(new Array(2), function(i){
      ...
      ,headerChild = [function(){ //上一年
        ...
        elem.innerHTML = '<svg width="14px" height="14px" t="1689045389072" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2371"><path d="M170.666667 533.333333L490.666667 213.333333l29.866666 29.866667-290.133333 290.133333 290.133333 290.133334-29.866666 29.866666L170.666667 533.333333z m298.666666 0L789.333333 213.333333l29.866667 29.866667-290.133333 290.133333 290.133333 290.133334-29.866667 29.866666-320-320z" p-id="2372"></path></svg>';
        return elem;
      }(), function(){ //上一月
        var elem = lay.elem('i', {
          "class": 'layui-icon laydate-icon laydate-prev-m'
        });
        elem.innerHTML = '<svg  width="12px" height="12px" t="1689045750099" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2526"><path d="M396.8 494.933333l332.8-332.8-29.866667-29.866666-362.666666 362.666666 362.666666 362.666667 29.866667-29.866667-332.8-332.8z" p-id="2527"></path></svg>';
        return elem;
      }(), function(){ //年月选择
        ...
        elem.innerHTML = '<svg width="14px" height="14px" t="1689045804221" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3494"><path d="M759.466667 533.333333L469.333333 243.2l29.866667-29.866667 320 320-320 320-29.866667-29.866666 290.133334-290.133334z m-298.666667 0L170.666667 243.2l29.866666-29.866667 320 320L200.533333 853.333333l-29.866666-29.866666 290.133333-290.133334z" p-id="3495"></path></svg>';
        return elem;
      }()]
    ...
    lay(divFooter).html(function(){
      ...
      lay.each(options.btns, function(i, item){
        ...
        if(isStatic && item === 'clear') title = options.lang === 'zh-CN' ? '重置' : 'Reset';
